...
public record TemplateId(
    ...
    public static final TemplateId TRANSFERFACTORY_INTERFACE_ID = new TemplateId("#splice-api-token-holding-v1", "Splice.Api.Token.TransferInstructionV1", "TransferFactory");
